...
class Home extends StatefulWidget {
  ...
  const Home(this._scaffoldKey, this._pageController, {Key key}) : super(key: key);
...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScrollView(
      slivers: <Widget>[
        SliverAppBar(
          expandedHeight: 194 + MediaQuery.of(context).padding.top,
          title: Text('Rede de Postos Contorno'),
                    ...
                    Container(
                      ...
                      child: Padding(
                        padding: EdgeInsets.fromLTRB(
                            0, 20 + MediaQuery.of(context).padding.top, 0, 0),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: <Widget>[
                            // Text(
